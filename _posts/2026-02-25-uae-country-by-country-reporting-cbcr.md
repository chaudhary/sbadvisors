...
1.  **Check the threshold:** Does your group's consolidated revenue exceed AED 3.15 billion? If yes, CbCR obligations apply.
2.  **Identify your Reporting Entity:** Determine whether the UPE, Surrogate Parent, or a UAE constituent entity will file the CbCR.
3.  **File the annual notification:** Every UAE constituent entity in a qualifying MNE group must file the annual notification with the UAE Ministry of Finance, even if the CbCR itself is filed abroad.
4.  **Prepare accurate group data:** The CbCR requires precise, jurisdiction-by-jurisdiction financial and headcount data — this requires coordination across the group.
5.  **Align with your transfer pricing documentation:** CbCR should be consistent with your Master File and Local File positions.
