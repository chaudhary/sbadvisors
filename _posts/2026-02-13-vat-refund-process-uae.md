...
image: "/assets/img/blog/blog-vat-refund-process-uae.png"
---
...
2.  Navigate to your VAT registration and select **"VAT Refund Request"**.
3.  Confirm the refund amount (this will be pre-populated from your return).
4.  Complete the required fields, including your bank account details (IBAN).
5.  Upload supporting documentation as requested.
...
1.  **Invalid tax invoices:** Invoices missing required fields (supplier TRN, VAT amount stated separately, invoice number, etc.) will result in denied input tax claims.
2.  **Input tax claimed on non-business expenses:** Personal expenses or entertainment costs (which have specific recovery restrictions) cannot be fully recovered.
3.  **Input tax on blocked items:** Certain items are explicitly blocked from VAT recovery, including motor vehicles available for personal use and entertainment expenses.
4.  **Missing IBAN:** Refunds cannot be processed without a valid UAE IBAN linked to your EmaraTax account.
5.  **Outstanding tax liabilities:** The FTA may offset any outstanding VAT, Corporate Tax, or penalty balances before issuing a refund.
